...
public final class HistoryPoint {
    ...
    public static final String BRANCH_IDENTIFIER_DEFAULT_COMPACT = BRANCH_IDENTIFIER_SEPARATOR_COMPACT + "1";
     ...
     */
    public HistoryPoint(boolean compact) {
    ...
    public String getBranchIdentifier() {
        ...
        retVal.append(this.compact ? BRANCH_IDENTIFIER_DEFAULT_COMPACT : BRANCH_IDENTIFIER_DEFAULT_LONG);
