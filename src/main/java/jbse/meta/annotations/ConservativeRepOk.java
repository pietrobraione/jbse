...
/**
 * Indicates that the target is a conservative rep ok method that 
 * must be invoked upon assumptions by expansion. The annotation 
...
public @interface ConservativeRepOk {
}
