...
public final class Signatures {
    ...
    public static final String JBSE_ANALYSIS                 = binaryToInternalClassName(jbse.meta.Analysis.class.getName());
    public static final String JBSE_BASE                     = binaryToInternalClassName(jbse.base.Base.class.getName());
