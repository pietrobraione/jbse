 ...
 * against the (partial) heaps of symbolic states.
 * 
    ...
    private static class MethodUnderTest {
        ...
        private void appendMethodDeclaration(State initialState, State finalState, int testCounter) {
            ...
            for (Symbolic symbol : inputs) {
                ...
                if (symbol instanceof ReferenceSymbolic) {
                    ...
                    final String className = internalToCanonicalTypeName(type);
        ...
        throws FrozenStateException {        
            ...
            if (isArray(type)) {
                ...
                instantiationStmt = "alloc.newArray(\"" + internalToBinaryTypeName(getArrayMemberType(type)) + "\", " + length.toString() + ")";
            } else {
                instantiationStmt = "alloc.newInstance(\"" + internalToBinaryTypeName(type) + "\")";
            }
        ...
        private static String getValue(String accessExpression) {
        ...
        private static Set<PrimitiveSymbolic> symbolsIn(Primitive e) {
