...
extends Algorithm<BytecodeData_1KME, R, DE, RE, UP> {
    ...
    protected boolean isInterface; //set by setter
    protected boolean isSpecial; //set by setter
    protected boolean isStatic; //set by setter
    protected boolean isOverriddenMethodNative; //set by setter
    protected Signature methodSignatureImplementation; //set by setter
