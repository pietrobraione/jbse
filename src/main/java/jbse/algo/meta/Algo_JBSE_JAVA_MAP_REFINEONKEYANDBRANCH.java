 ...
 */
public final class Algo_JBSE_JAVA_MAP_REFINEONKEYANDBRANCH extends Algo_INVOKEMETA<
        ...
        return (state) -> {
            ...
            try {
                ...
                if (state.isNull(this.thisReference)) {
                    ...
                    failExecution("The 'this' parameter to jbse.base.JAVA_MAP.refineOnKeyAndBranch method is null.");
                }
