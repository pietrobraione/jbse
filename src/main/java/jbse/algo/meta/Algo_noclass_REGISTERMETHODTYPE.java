 ...
 * {@code java.lang.invoke.MethodType}. Its first parameter is a meta-level box
 * containing an array of {@link ClassFile}s, the resolved descriptor, its second 
 * parameter is the {@code java.lang.invoke.MethodType} produced by a call to 
 * {@code java.lang.invoke.MethodHandleNatives.findMethodHandleType}.
 * 
...
public final class Algo_noclass_REGISTERMETHODTYPE extends Algo_INVOKEMETA_Nonbranching {
    ...
    protected void cookMore(State state) throws FrozenStateException {
        try {
        	final Reference refDescriptor = (Reference) this.data.operand(0);
