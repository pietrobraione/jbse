 ...
 */
//TODO merge with Algo_JAVA_ZIPFILE_STARTSWITHLOC and Algo_JAVA_ZIPFILE_GETENTRYFLAG and Algo_JAVA_ZIPFILE_GETTOTAL and Algo_JAVA_ZIPFILE_GETENTRYTIME and Algo_JAVA_ZIPFILE_GETENTRYCSIZE and Algo_JAVA_ZIPFILE_GETENTRYMETHOD
public final class Algo_JAVA_ZIPFILE_GETENTRYCRC extends Algo_INVOKEMETA_Nonbranching {
    ...
    throws InterruptException, ClasspathException, SymbolicValueNotAllowedException {
        try {
            ...
            if (_jzentry.isSymbolic()) {
                throw new SymbolicValueNotAllowedException("The long jzentry parameter to invocation of method java.util.zip.ZipFile.getEntryCrc cannot be a symbolic value.");
            }
            ...
            final Method method = ZipFile.class.getDeclaredMethod("getEntryCrc", long.class);
