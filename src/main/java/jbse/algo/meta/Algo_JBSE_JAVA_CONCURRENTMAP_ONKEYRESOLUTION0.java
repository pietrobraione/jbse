...
import static jbse.bc.Signatures.JBSE_JAVA_CONCURRENTMAP_ONKEYRESOLUTIONCOMPLETE;
...
/**
 * Meta-level implementation of {@link jbse.base.JAVA_CONCURRENTMAP#onKeyResolution0(Object)}.
 *  
 * @author Pietro Braione
 *
 */
public final class Algo_JBSE_JAVA_CONCURRENTMAP_ONKEYRESOLUTION0 extends Algo_INVOKEMETA_Nonbranching {
    @Override
    ...
    CannotManageStateException, InterruptException, FrozenStateException {
        try {           
            ...
            final Snippet snippet = state.snippetFactoryNoWrap()
            		...
            		.op_aload((byte) 1)
            		//invokes
            		.op_invokestatic(JBSE_JAVA_CONCURRENTMAP_ONKEYRESOLUTIONCOMPLETE)
            		.op_return()
            		.mk();
