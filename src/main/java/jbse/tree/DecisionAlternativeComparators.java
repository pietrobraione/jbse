...
public final class DecisionAlternativeComparators {
            ...
            public int compare(DecisionAlternative_XLOAD_GETX o1, DecisionAlternative_XLOAD_GETX o2) {
                if (o1 instanceof DecisionAlternative_XLOAD_GETX_Resolved) {
                    ...
                    o2 instanceof DecisionAlternative_XLOAD_GETX_Null) {
                        ...
                        final long d = daro2.getObjectPosition() - daro1.getObjectPosition();
                    ...
                    if (o2 instanceof DecisionAlternative_XLOAD_GETX_Expands) {
                        ...
                        return darc2.getClassFileOfTargetObject().compareTo(darc1.getClassFileOfTargetObject());
                    } else {
                        return 1;
                    }
                } else {
     ...
     * by the {@link DecisionAlternativeComparators} getters. 
     * 
     * @param cb 
