...
public class DecisionProcedureAlgorithms extends DecisionProcedureDecorator {
    ...
    throws DecisionException {
        try {
            final boolean shouldRefine;
	        final Expression accessExpressionSpecialized = (Expression) this.calc.simplify(accessExpression.replace(indexFormal, indexActual));
    ...
    IncompatibleClassFileException, ClassFileNotAccessibleException {
        try {
            final boolean accessConcrete = (accessExpression == null);
	        final Expression accessExpressionSpecialized = (accessExpression == null ? null : (Expression) this.calc.simplify(accessExpression.replace(indexFormal, indexActual)));
            final boolean shouldRefine;
