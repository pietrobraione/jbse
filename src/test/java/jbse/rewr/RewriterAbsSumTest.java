...
public class RewriterAbsSumTest {
	...
	public void testBasic1() throws Exception {
		...
		final Primitive absA = this.calc.applyFunctionPrimitive(Type.FLOAT, this.hist, PrimitiveSymbolicApply.ABS, A); 
	...
	public void testBasic3() throws Exception {
		...
		final Primitive absA = this.calc.applyFunctionPrimitive(Type.INT, this.hist, PrimitiveSymbolicApply.ABS, A); 
	...
	public void testBasic4() throws Exception {
		...
		final Primitive absA = this.calc.applyFunctionPrimitive(Type.LONG, this.hist, PrimitiveSymbolicApply.ABS, A); 
	...
	public void testComposite1() throws Exception {
		...
		final Primitive absAplusB = this.calc.applyFunctionPrimitive(Type.FLOAT, this.hist, PrimitiveSymbolicApply.ABS, A.add(B)); 
	...
	public void testComposite2() throws Exception {
		...
		final Primitive absBminusA = this.calc.applyFunctionPrimitive(Type.DOUBLE, this.hist, PrimitiveSymbolicApply.ABS, B.sub(A)); 
