...
public class RewriterAbsSumTest {
	...
	public void testBasic1() throws Exception {
		...
		final Primitive absA = calc.applyFunctionPrimitive(Type.FLOAT, null, PrimitiveSymbolicApply.ABS, A); 
	...
	public void testBasic3() throws Exception {
		...
		final Primitive absA = calc.applyFunctionPrimitive(Type.INT, null, PrimitiveSymbolicApply.ABS, A); 
	...
	public void testBasic4() throws Exception {
		...
		final Primitive absA = calc.applyFunctionPrimitive(Type.LONG, null, PrimitiveSymbolicApply.ABS, A); 
	...
	public void testComposite1() throws Exception {
		...
		final Primitive absAplusB = calc.applyFunctionPrimitive(Type.FLOAT, null, PrimitiveSymbolicApply.ABS, A.add(B)); 
	...
	public void testComposite2() throws Exception {
		...
		final Primitive absBminusA = calc.applyFunctionPrimitive(Type.DOUBLE, null, PrimitiveSymbolicApply.ABS, B.sub(A)); 
