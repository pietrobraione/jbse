 ...
 */
public class PrimitiveSymbolic extends Primitive implements Symbolic {
    ...
    /** The origin. */
    private String origin; //TODO make it final!
    ...
    /**
     * {@inheritDoc Symbolic#setOrigin(String)}
     */
    //TODO deprecate / remove it
     ...
     */
	@Override
	public PrimitiveSymbolic clone() {
		return (PrimitiveSymbolic) super.clone();
	}
