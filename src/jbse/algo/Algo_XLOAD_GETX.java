...
/**
 * Class for completing the semantics of the *load*, *load and get* bytecodes 
 * ([a/d/f/i/l]load[_0/1/2/3], [a/d/f/i/l]load, get[field/static]). 
	    ...
	    return (state, result) -> {
            ...
            if (this.refNotExpanded) {
                try {
                    ...
                    this.nonExpandedRefOrigin = refToLoad.getOrigin();
